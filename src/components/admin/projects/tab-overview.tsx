...
export function ProjectOverviewTab({ project }: { project: AdminProjectDetail }) {
  return (
    <div className="space-y-6">
      {/*
        Dedicated client section, separated from the project fields below.
        The project's client relationship is projects.client_id -> profiles.id.
      */}
      <ClientDetailsCard details={project.clientDetails} />
