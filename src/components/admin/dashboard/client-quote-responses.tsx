              ...
              <div className="grid gap-3 sm:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)_minmax(0,1.3fr)_8.5rem_auto] sm:items-start sm:gap-4">
                ...
                <div className="sm:text-right">
                  <Link
                    ...
                    className="inline-flex items-center gap-1 rounded-xl border border-card-border bg-background px-3 py-1.5 text-xs font-medium text-foreground hover:border-foreground/30"
                  >
